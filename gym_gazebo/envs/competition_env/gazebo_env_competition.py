...
class Competition_Env(gazebo_env.GazeboEnv):
    

    def __init__(self):
        # Launch the simulation with the given launchfile name NEED TO UPDATE IF CHANGE FOLDERS
        LAUNCH_FILE = '/home/gosha/Code/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/competition_ros_pkg/enph353/enph353_utils/launch/sim.launch'
